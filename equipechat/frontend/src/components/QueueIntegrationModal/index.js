...
const DialogflowSchema = Yup.object().shape({
  name: Yup.string()
    .min(2, i18n.t("queueIntegration.validation.tooShort"))
    .max(50, i18n.t("queueIntegration.validation.tooLong"))
    .required(i18n.t("queueIntegration.validation.required")),
  // projectName: Yup.string()
  //   .min(3, i18n.t("queueIntegration.validation.tooShort"))
  //   .max(100, i18n.t("queueIntegration.validation.tooLong"))
  //   .required(),
  // jsonContent: Yup.string().min(3, i18n.t("queueIntegration.validation.tooShort")).required(),
  // language: Yup.string().min(2, i18n.t("queueIntegration.validation.tooShort")).max(50, i18n.t("queueIntegration.validation.tooLong")).required(),
});
                    ...
                    <Grid item xs={12} md={6} xl={6}>
                      ...
                      >
                        ...
                        <Field
                          ...
                          required
                        >
                          <MenuItem value="dialogflow">{i18n.t("queueIntegrationModal.integrationTypes.dialogflow")}</MenuItem>
                          <MenuItem value="n8n">{i18n.t("queueIntegrationModal.integrationTypes.n8n")}</MenuItem>
                          <MenuItem value="webhook">{i18n.t("queueIntegrationModal.integrationTypes.webhook")}</MenuItem>
                          <MenuItem value="typebot">{i18n.t("queueIntegrationModal.integrationTypes.typebot")}</MenuItem>
                          <MenuItem value="flowbuilder">{i18n.t("queueIntegrationModal.integrationTypes.flowbuilder")}</MenuItem>
                        </Field>
                      </FormControl>
                    </Grid>
                        ...
                        <Grid item xs={12} md={6} xl={6}>
                          ...
                          >
                            ...
                            <Field
                              ...
                              required
                            >
                              <MenuItem value="pt-BR">{i18n.t("queueIntegration.languages.portuguese")}</MenuItem>
                              <MenuItem value="en">{i18n.t("queueIntegration.languages.english")}</MenuItem>
                              <MenuItem value="es">{i18n.t("queueIntegration.languages.spanish")}</MenuItem>
                            </Field>
                          </FormControl>
                        </Grid>
                        <Grid item xs={12} md={6} xl={6}>
