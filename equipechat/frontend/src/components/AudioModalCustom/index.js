...
const AudioModalCustom = ({
  ...
  // Efeito para lidar com reprodução automática
  useEffect(() => {
  ...
  // Efeito para configurar eventos do áudio
  useEffect(() => {
  ...
  const getAudioSource = () => {
    ...
    if (isIOS || isSafari) {
      ...
      return <source src={sourceUrl} type="audio/mp3" />;
    }
