...
const QueueSchema = Yup.object().shape({
  ...
  chatbots: Yup.array()
    .of(
      Yup.object().shape({
        name: Yup.string().min(4, i18n.t("queueModal.validation.tooShort")).required(i18n.t("queueModal.validation.required")),
      })
    )
    .required(i18n.t("queueModal.validation.mustHaveFriends")),
});
...
const QueueModal = ({ open, onClose, queueId, onEdit }) => {
  ...
  const initialStateSchedule = [
    ...
    { weekday: i18n.t("queueModal.serviceHours.saturday"), weekdayEn: "saturday", startTimeA: "08:00", endTimeA: "12:00", startTimeB: "13:00", endTimeB: "18:00" },
    { weekday: i18n.t("queueModal.serviceHours.sunday"), weekdayEn: "sunday", startTimeA: "08:00", endTimeA: "12:00", startTimeB: "13:00", endTimeB: "18:00" }
  ];
  ...
  const handleSaveSchedules = async (values) => {
    toast.success(i18n.t("queues.toasts.clickSave"));
    setSchedules(values);
    setTab(0);
  };
                ...
                <DialogContent dividers>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <MenuItem value="1">1 {i18n.t("queueModal.form.minutes.singular")}</MenuItem>
                      <MenuItem value="2">2 {i18n.t("queueModal.form.minutes.plural")}</MenuItem>
                      <MenuItem value="3">3 {i18n.t("queueModal.form.minutes.plural")}</MenuItem>
                      <MenuItem value="4">4 {i18n.t("queueModal.form.minutes.plural")}</MenuItem>
                    ...
                    <Field
                      ...
                      disabled={!values.ativarRoteador}
                    >
                      <MenuItem value="0" selected disabled>{i18n.t("queueModal.form.selectRotationType")}</MenuItem>
                  ...
                  <div>
                    {showIntegrations && (
                      ...
                      >
                        ...
                        >
                          <MenuItem value={""} >{i18n.t("queueModal.form.none")}</MenuItem>
                                        ...
                                        {isGreetingMessageEdit !== index ? (
                                          ...
                                          >
                                            <Typography
                                              ...
                                              variant="body1"
                                            >
                                              {i18n.t("queueModal.bot.messageLabel")}
                                            </Typography>
                                          ...
                                          <Grid spacing={2} container>
                                            ...
                                            {queue.chatbots[index].queueType === "file" && (
                                              <>
                                                ...
                                                <InputLabel>{i18n.t("queueModal.form.selectFile")}</InputLabel>
                                                <Field
                                                  as={Select}
