...
const TicketOptionsMenu = ({ ticket, menuOpen, handleClose, anchorEl }) => {
  ...
  const [finalizacaoVendaModalOpen, setFinalizacaoVendaModalOpen] =
    useState(false);
  ...
  const handleOpenFinalizacaoVendaModal = () => {
    handleClose();
    setFinalizacaoVendaModalOpen(true);
  };

  const handleCloseFinalizacaoVendaModal = () => {
    setFinalizacaoVendaModalOpen(false);
  };
    ...
    <>
      ...
      >
        ...
        {user?.finalizacaoComValorVendaAtiva === "true" ? (
          <MenuItem onClick={handleOpenFinalizacaoVendaModal}>
            Finalizar com Valor de Venda
          </MenuItem>
        ) : (
      ...
      <FinalizacaoVendaModal
        open={finalizacaoVendaModalOpen}
        onClose={handleCloseFinalizacaoVendaModal}
        ticket={ticket}
      />
    </>
  );
