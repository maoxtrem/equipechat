...
const QuickMessageDialog = ({ open, onClose, quickemessageId, reload }) => {
  ...
  // Helper function to get basename without using Node.js path module
                      ...
                      <Grid xs={12} item>
                        <Box className={classes.mediaContainer}>
                          <Typography variant="h6" gutterBottom>
                            {i18n.t("quickMessages.dialog.attachMedia")}
                          </Typography>
                            ...
                            <>
                              <Box className={classes.mediaInfo}>
                                <Box display="flex" alignItems="center" gap={1}>
                                  <MicIcon />
                                  <Typography variant="body2">
                                    {i18n.t("quickMessages.dialog.newAudioRecorded")}
                                  </Typography>
                          ...
                          {(!hasAnyMedia || isEditingMedia) && (
                            <>
                              {isEditingMedia && hasExistingMedia && (
                                <>
                                  ...
                                  <Typography variant="body2" color="textSecondary" align="center">
                                    {i18n.t("quickMessages.dialog.chooseNewMediaToReplace")}
                                  </Typography>
                                </>
                              )}
                              ...
                              {!hasAnyMedia && (
                                <Typography variant="body2" color="textSecondary" align="center">
                                  {i18n.t("quickMessages.dialog.chooseMediaOption")}
                                </Typography>
                              )}
                    ...
                    <>
                      <Grid xs={12} item>
                        <DataGrid
                          rows={rowsWithIds}
                          columns={[
                            { field: "type", headerName: i18n.t("quickMessages.dialog.type"), width: 150 },
                            { field: "text", headerName: i18n.t("quickMessages.dialog.value"), width: 400 },
                          ]}
                          pageSize={5}
