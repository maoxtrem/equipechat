...
const FlowBuilderMenuModal = ({ open, onSave, onUpdate, data, close }) => {
  ...
  const [labels, setLabels] = useState({
    title: i18n.t("flowBuilderConfig.modals.menu.addTitle"),
    btn: i18n.t("flowBuilderConfig.modals.menu.addButton"),
  });
  ...
  useEffect(() => {
    ...
    if (open === "edit") {
      setLabels({
        title: i18n.t("flowBuilderConfig.modals.menu.editTitle"),
        btn: i18n.t("flowBuilderConfig.modals.menu.saveButton"),
      });
