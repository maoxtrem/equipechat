    ...
    >
      <Fade in={open}>
        <div className={classes.paper}>
          ...
          <h2 id="transition-modal-title">{tag.name} - {i18n.t("tags.contactModal.title")}</h2>
          <TableContainer component={Paper}>
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell>{i18n.t("tags.contactModal.tableHeaders.id")}</TableCell>
                  <TableCell>{i18n.t("tags.contactModal.tableHeaders.name")}</TableCell>
                  <TableCell>{i18n.t("tags.contactModal.tableHeaders.number")}</TableCell>
                  <TableCell>{i18n.t("tags.contactModal.tableHeaders.actions")}</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {tagList?.map((contact) => (
