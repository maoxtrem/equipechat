  ...
  return (
    <>
      <Grid spacing={3} container>
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer}>
            ...
            >
              <MenuItem value={"text"}>{i18n.t("settings.settings.options.text")}</MenuItem>
            </Select>
            <FormHelperText>
              {loadingScheduleType && i18n.t("settings.settings.options.updating")}
            </FormHelperText>
      ...
      <Grid spacing={3} container style={{ marginBottom: 10 }}>
          ...
          >
            <Tab label={i18n.t("settings.settings.options.configurationCopyPrefix")} />
          </Tabs>
    ...
    shrink: true,
      ...
      <Grid spacing={3} container>
        {isSuper() ?
          ...
          >
            <Tab label={i18n.t("settings.settings.options.configurationPix")} />
          </Tabs>
          : null}
      </Grid>
          ...
          {isSuper() ?
            <FormControl className={classes.selectContainer}>
              <TextField
                ...
                name='eficlientid'
                margin='dense'
                label={i18n.t("settings.settings.options.clientId")}
                variant='outlined'
              ...
              ></TextField>
              <FormHelperText>
                {loadingEfiClientidType && i18n.t("settings.settings.options.updating")}
              </FormHelperText>
            </FormControl>
            : null}
        </Grid>
          ...
          {isSuper() ?
            <FormControl className={classes.selectContainer}>
              <TextField
                ...
                margin='dense'
                label={i18n.t("settings.settings.options.clientSecret")}
                variant='outlined'
              ...
              ></TextField>
              <FormHelperText>
                {loadingEfiClientsecretType && i18n.t("settings.settings.options.updating")}
              </FormHelperText>
            </FormControl>
            : null}
        </Grid>
          ...
          {isSuper() ?
            <FormControl className={classes.selectContainer}>
              <TextField
                ...
                name='efichavepix'
                margin='dense'
                label={i18n.t("settings.settings.options.pixKey")}
                variant='outlined'
              ...
              ></TextField>
              <FormHelperText>
                {loadingEfiChavepixType && i18n.t("settings.settings.options.updating")}
              </FormHelperText>
            </FormControl>
            : null}
        </Grid>
      ...
      <Grid spacing={3} container>
        {isSuper() ?
          ...
          >
            <Tab label={i18n.t("settings.settings.options.mercadoPago")} />
          </Tabs>
          : null}
      </Grid>
          ...
          {isSuper() ?
            <FormControl className={classes.selectContainer}>
              <TextField
                ...
                name='mpaccesstoken'
                margin='dense'
                label={i18n.t("settings.settings.options.accessToken")}
                variant='outlined'
              ...
              ></TextField>
              <FormHelperText>
                {loadingmpaccesstokenType && i18n.t("settings.settings.options.updating")}
              </FormHelperText>
            </FormControl>
            : null}
        </Grid>
      ...
      <Grid spacing={3} container>
        {isSuper() ?
          ...
          >
            <Tab label={i18n.t("settings.settings.options.stripe")} />
          </Tabs>
          : null}
      </Grid>
          ...
          {isSuper() ?
            <FormControl className={classes.selectContainer}>
              <TextField
                ...
                margin='dense'
                label={i18n.t("settings.settings.options.stripePrivateKey")}
                variant='outlined'
              ...
              ></TextField>
              <FormHelperText>
                {loadingstripeprivatekeyType && i18n.t("settings.settings.options.updating")}
              </FormHelperText>
            </FormControl>
            : null}
        </Grid>
      ...
      <Grid spacing={3} container>
        {isSuper() ?
          ...
          >
            <Tab label={i18n.t("settings.settings.options.asaas")} />
          </Tabs>
          : null}
      </Grid>
          ...
          {isSuper() ?
            <FormControl className={classes.selectContainer}>
              <TextField
                ...
                name='asaastoken'
                margin='dense'
                label={i18n.t("settings.settings.options.asaasToken")}
                variant='outlined'
              ...
              ></TextField>
              <FormHelperText>
                {loadingasaastokenType && i18n.t("settings.settings.options.updating")}
              </FormHelperText>
            </FormControl>
            : null}
        </Grid>
