          ...
          <Table className={classes.table}>
            <TableHead>
              <TableRow>
                ...
                <TableCell>{i18n.t('salesReport.table.attendant')}</TableCell>
                <TableCell>{i18n.t('salesReport.table.date')}</TableCell>
                <TableCell>{i18n.t('salesReport.table.saleValue')}</TableCell>
                <TableCell>{i18n.t('salesReport.table.noSaleReason')}</TableCell>
                <TableCell>{i18n.t('salesReport.table.finalizationReason')}</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
        ...
        <Table className={classes.table}>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">{i18n.t('salesReport.table.totalSales')}</TableCell>
              <TableCell align="right">{i18n.t('salesReport.table.totalSalesValue')}</TableCell>
              <TableCell align="right">Não Vendas</TableCell>
              <TableCell align="right">{i18n.t('salesReport.table.totalTickets')}</TableCell>
