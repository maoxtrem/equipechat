        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">{i18n.t('salesReport.table.details')}</TableCell>

              <TableCell align="center">{i18n.t('salesReport.table.users')}</TableCell>
              <TableCell align="center">{i18n.t('salesReport.table.connections')}</TableCell>
              <TableCell align="center">{i18n.t('salesReport.table.queues')}</TableCell>
