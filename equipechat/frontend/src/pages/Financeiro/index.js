...
const Invoices = () => {
  ...
  return (
    <MainContainer>
      ...
      ></SubscriptionModal>
      <MainHeader>
        <Title>{i18n.t("financial.title")} ({invoices.length})</Title>
        {isCompanyExpired && (
          <div style={{ 
        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">{i18n.t("financial.details")}</TableCell>

              <TableCell align="center">{i18n.t("financial.users")}</TableCell>
              <TableCell align="center">{i18n.t("financial.connections")}</TableCell>
              <TableCell align="center">{i18n.t("financial.queues")}</TableCell>
              ...
              <TableCell align="center">{i18n.t("financial.value")}</TableCell>
              <TableCell align="center">{i18n.t("financial.expirationDate")}</TableCell>
              <TableCell align="center">{i18n.t("financial.status")}</TableCell>
              <TableCell align="center">{i18n.t("financial.action")}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <>
