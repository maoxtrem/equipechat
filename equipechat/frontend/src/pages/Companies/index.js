...
const Companies = () => {
  ...
  const renderWhatsapp = (row) => {
    return row.useWhatsapp === false ? i18n.t("common.no") : i18n.t("common.yes");
  };

  const renderFacebook = (row) => {
    return row.useFacebook === false ? i18n.t("common.no") : i18n.t("common.yes");
  };

  const renderInstagram = (row) => {
    return row.useInstagram === false ? i18n.t("common.no") : i18n.t("common.yes");
  };

  const renderCampaigns = (row) => {
    return row.useCampaigns === false ? i18n.t("common.no") : i18n.t("common.yes");
  };

  const renderSchedules = (row) => {
    return row.useSchedules === false ? i18n.t("common.no") : i18n.t("common.yes");
  };

  const renderInternalChat = (row) => {
    return row.useInternalChat === false ? i18n.t("common.no") : i18n.t("common.yes");
  };

  const renderExternalApi = (row) => {
    return row.useExternalApi === false ? i18n.t("common.no") : i18n.t("common.yes");
  };
