...
// Registrar rotas de idiomas ANTES das outras rotas de API para garantir que as rotas públicas funcionem
...
// Remover rota duplicada de languageRoutes (já foi movida para cima)
