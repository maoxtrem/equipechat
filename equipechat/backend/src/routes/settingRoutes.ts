...
import * as PublicSettingController from "../controllers/PublicSettingController";
...
// Rota pública para buscar logos (página de login)
settingRoutes.get("/public/logos", PublicSettingController.getPublicLogos);
